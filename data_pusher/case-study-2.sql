...
DROP TABLE IF EXISTS pizza_runner_runners
CREATE TABLE pizza_runner_runners (
  runner_id Int8,
  registration_date DATE
)
ENGINE=MergeTree() ORDER BY runner_id

INSERT INTO pizza_runner_runners
...
DROP TABLE IF EXISTS pizza_runner_customer_orders
CREATE TABLE pizza_runner_customer_orders (
  order_id Int8,
  customer_id Int8,
  pizza_id Int8,
  exclusions String,
...
INSERT INTO pizza_runner_customer_orders
...
DROP TABLE IF EXISTS pizza_runner_pizza_toppings;
